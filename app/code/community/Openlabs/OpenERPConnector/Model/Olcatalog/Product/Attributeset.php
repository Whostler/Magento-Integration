 ...
 */
class Openlabs_OpenERPConnector_Model_Olcatalog_Product_Attributeset extends Mage_Api_Model_Resource_Abstract
{
    /**
    ...
    /**
     * Retrieve attribute set list ids
     *
     * @return array
     */       
     ...
     * @return array
     */
    public function info($setId = null) {
        if (is_numeric($setId)) {
            try {
